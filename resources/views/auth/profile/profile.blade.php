...
@section('content')
    <div class="profile-header" style="background: linear-gradient(135deg, #004D40, #74B176); color: white; padding: 1.5rem 2rem; border-radius: 12px; margin-bottom: 2rem;">
    ...
    <div class="avatar1" onclick="openModal()" 
        ...
        @if(auth()->user()->profile_photo)
            <img src="{{ asset('storage/' . auth()->user()->profile_photo) }}"
                 alt="Avatar"
                 style="width:100%; height:100%; object-fit:cover; border-radius:50%; border:4px solid #004D40;">
        @else
            <div style="width:100%; height:100%; border-radius:50%; border:4px solid #004D40; 
                        background:#e3f2fd; display:flex; align-items:center; justify-content:center;">
                <i class="fa fa-user" style="font-size:40px; color:#004D40;"></i>
            </div>
        @endif

        <span class="edit-icon"
              style="position:absolute; bottom:5px; right:5px; background:#004D40; color:white; width:32px; height:32px; border-radius:50%; display:flex; align-items:center; justify-content:center; border:2px solid white;">
            <i class="fa fa-pen"></i>
        </span>
    ...
    <span class="role"
          style="display:inline-block; background:#e3f2fd; color:#004D40; font-weight:600; padding:0.3rem 1rem; border-radius:20px;">
        ...
        <div class="card" style="position:relative; padding:1.5rem;">
            <h4 style="font-size:1.25rem; margin-bottom:1.5rem; border-bottom:2px solid #004D40; padding-bottom:0.5rem; display:inline-block;">Data Diri</h4>
            ...
            @endif
            <a href="{{ route('profile.edit') }}" class="btn-edit" style="position:absolute; top:1.5rem; right:1.5rem; background:#004D40; color:white; padding:0.5rem 1.2rem; border-radius:30px; text-decoration:none; display:inline-flex; align-items:center; gap:0.5rem;">
